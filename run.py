...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Matthew Sessions', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:matthewlsessions@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/matthew-sessions'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/matthew-sessions/'), 
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/Matt_Sesh>'), 
                ], 
                className='lead'
            )
        )
